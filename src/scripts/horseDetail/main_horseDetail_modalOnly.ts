 ...
 *
 * 使い方:
 *   npx tsx src/scripts/horseDetail/main_horseDetail_modalOnly.ts YYYY MM [DD]
 *   例) npx tsx src/scripts/horseDetail/main_horseDetail_modalOnly.ts 2026 7
 *   例) npx tsx src/scripts/horseDetail/main_horseDetail_modalOnly.ts 2026 7 5
 */
